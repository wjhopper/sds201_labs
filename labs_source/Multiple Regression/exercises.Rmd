...
Back in Exercise 5 of Problem Set 6, we found that when we predicted the hate crime rate in Colorado with just the GINI index alone, our bivariate regression model had a residual error of 0.088. How much more accurate is this multiple regression model for predicting the hate crime rate in Colorado, in terms of absolute error?
