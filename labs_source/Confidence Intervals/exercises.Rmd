...
## Exercise
Estimate the **90%** confidence interval for new textbook prices at the campus bookstore data based on just the original sample (i.e., the `textbooks` data frame).
