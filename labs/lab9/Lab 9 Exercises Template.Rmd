...
## Exercise
Construct a bootstrap sampling distribution of the average campus bookstore textbook price using 1,000 bootstrap replicates. Visualize the bootstrap distribution using a histogram, and describe the distribution you see.
...
## Exercise
Estimate the **90%** confidence interval based on the original sample of prices in the `textbooks` data frame.
...
## Exercise
Re-sample 100 more data sets from the original `textbooks` data set, but don't combine them together to create a bootstrap sampling distribution. Instead, find the mean and variance of each one, and create a 90% confidence interval for each re-sampled data set (using the same method you used in Exercise #3).
